...
class Board {
    ...
    setTableBackground(newBackground) {
        ...
        if (newBackground && typeof newBackground === "object") {
            ...
            if(changed) {
                dBoard("Table background changed. New background: %o", this.tableBackground);
            } else {
    ...
    updateBoardProperties(newProps) {
        ...
        this.boardPhysical.heightPx = this.boardPhysical.heightUser * unitMultiplier;
        dBoard(
        ...
        if (overallChange) {
            ...
            dBoard("No user-facing board properties or calculated pixel dimensions changed.");
        }
